...
<div class="container">
    <div class="card-deck mb-3 text-center">
        ...
        <div class="card mb-4" style="min-width: 320px">
            <div class="card-body">
                <img src="/files/image/tickets/<?=$ticket->photo?>" alt="" style="width: 90%;" draggable="false">
            </div>
        </div>
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-body">
                ...
                <br>
                <h3 class="card-title pricing-card-title">Цена: <?=$ticket->price?> руб</h3>
                <br><br>
                <a class="btn btn-block" href="/application_ticket/?id_ticket=<?=$ticket->id?>">Забронировать</a><br>
            </div>
        </div>
    </div>
</div>
