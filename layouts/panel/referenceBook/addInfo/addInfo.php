...
$addInfo = $dataAdmin->getAllAddInfo();
        ...
        <div class="card-body">
            <div id="accordion">
                <div class="card card-success">
                    ...
                    <form action="/layouts/panel/referenceBook/addInfo/add.php" method="get">
                ...
                <div class="card">
                    <div class="card-body table-responsive p-0" style="max-height: 450px;">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach ($addInfo as $s): ?>
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    <td class="text-center"><?= $s->id ?></td>
                                    <td><?= $s->title ?></td>
                                    <td class="project-actions text-center">
                                        <a href="/layouts/panel/referenceBook/addInfo/change/changeView.php?id=<?= $s->id ?>"
                                           class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                        <br><br>
                                        <a href="/layouts/panel/referenceBook/addInfo/delete.php?id=<?= $s->id ?>"
