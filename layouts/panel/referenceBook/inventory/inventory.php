        ...
        <div class="card-body">
            <div id="accordion">
                <div class="card card-success">
                    ...
                    <form action="/layouts/panel/referenceBook/inventory/add.php" method="get">
                ...
                <div class="card">
                    <div class="card-body table-responsive p-0" style="max-height: 450px;">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                            <?php foreach ($inventory as $s): ?>
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    <td class="text-center"><?= $s->id ?></td>
                                    <td class="text-center"><?= $s->title ?></td>

                                    <td class="project-actions text-center">
                                        <a href="/layouts/panel/referenceBook/inventory/change/changeView.php?id=<?= $s->id ?>"
                                           class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>

                                        <a href="/layouts/panel/referenceBook/inventory/delete.php?id=<?= $s->id ?>"
