...
$services = $dataAdmin->getAllServices();
        ...
        <div class="card-body">
            <div id="accordion">
                <div class="card card-success">
                    ...
                    <form action="/layouts/panel/referenceBook/services/add.php" method="get">
                            ...
                            <?php foreach ($services as $s): ?>
                                <tr data-widget="expandable-table" aria-expanded="false">
                                    ...
                                    <td class="text-center">
                                        <a href="/layouts/panel/referenceBook/services/change/changeView.php?id=<?= $s->id ?>"
                                           class="btn btn-primary"><i class="fas fa-pencil-alt"></i></a>
                                        <br><br>
                                        <a href="/layouts/panel/referenceBook/services/delete.php?id=<?= $s->id ?>"
